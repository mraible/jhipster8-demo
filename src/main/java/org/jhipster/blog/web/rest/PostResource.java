...
public class PostResource {
    ...
    public ResponseEntity<Post> getPost(@PathVariable("id") Long id) {
        ...
        if (post.isPresent()) {
            post
                ...
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.FORBIDDEN, "error.http.403"));
        }
    ...
    public ResponseEntity<?> deletePost(@PathVariable("id") Long id) {
        ...
        post
            ...
            .orElseThrow(() -> new ResponseStatusException(HttpStatus.UNAUTHORIZED, "error.http.401"));
