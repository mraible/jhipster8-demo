...
JHipster 8 is the same JHipster many developers know and love, with a couple of bright and shiny new features: namely Spring Boot 3, Angular 16, Vue 3, and Java 21 support.
...
image::static/jhipster7-demo-heroku.png[JHipster 8 Demo on Heroku, 800, scaledwidth=100%]
