...
This article shows you how to build a simple blog application with https://www.jhipster.tech/2024/03/20/jhipster-release-8.2.1.html[JHipster 8.2.1]. You can also https://www.youtube.com/watch?v=IfyjKCt6YHE[watch a screencast of this tutorial on YouTube].
